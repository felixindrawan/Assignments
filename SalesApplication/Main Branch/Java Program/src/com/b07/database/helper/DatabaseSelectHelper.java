...
public class DatabaseSelectHelper extends DatabaseSelector {
	...
	public static List<Integer> getUserActiveAccounts(int userId) throws SQLException {
		...
		Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
		ResultSet activeAccts = DatabaseSelector.getUserActiveAccounts(userId, connection);
		List<Integer> activeAccountList = new ArrayList<>();
		
		while (activeAccts.next()) {
			accountId = activeAccts.getInt("ID");
	...
	public static List<Integer> getUserInactiveAccounts(int userId) throws SQLException {
		...
		Connection connection = DatabaseDriverHelper.connectOrCreateDataBase();
		ResultSet inactiveAccts = DatabaseSelector.getUserInactiveAccounts(userId, connection);
		List<Integer> inactiveAccountList = new ArrayList<>();
		
		while (inactiveAccts.next()) {
			accountId = inactiveAccts.getInt("ID");
